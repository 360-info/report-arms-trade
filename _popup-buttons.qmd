...
```{=html}
<div id="edshare">
  <i id="edshare-icon" class="bi bi-clipboard-fill"></i>
  <div>
    <h4 id="edshare-title">GET THE STORY</h4>
  ...
  window.addEventListener("load", () => {
    ...
    edshareBtn.addEventListener("click", () => {
      ...
      edshareDescription.innerHTML =
        `Paste this interactive with the <i class="bi bi-code-square"></i> Embed button in your story editor.`;

      setTimeout(() => { 
          edshareBtn.classList.add("done");
      }, 5000)
    })
